    ...
    <div className="home">
      ...
      <section>
        <header className="header-banner">
          <img
            src="./assets/images/taj_background.jpg"
            alt="Phegon Hotel"
          ...
          <div className="animated-texts overlay-content">
            <h1>
              Welcome to <span className="phegon-color">LUXESTAY</span>
            </h1>
            <br />
            <marquee behavior="" direction="">
              <h3 color="">*Rooms Available*</h3>
            </marquee>
          </div>
        </header>
      </section>
      ...
      <h2 className="home-services">
        Services at <span className="phegon-color">LuxeStay</span>
      </h2>
